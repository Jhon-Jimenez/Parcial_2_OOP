...
class Observer(Protocol):
    """"
    The Observer class is a protocol, an abstract superclass for our observers
    """
...
class Observable:
    """
    The Observable class defines the _observers instance variable and three methods that are purely part of this protocol definition.
    This class makes calls to self._notify_observers() on important state changes
    """
...
class ZonkHandHistory(Observable):
    """"
    The implementation of a simple observer object;
    """
